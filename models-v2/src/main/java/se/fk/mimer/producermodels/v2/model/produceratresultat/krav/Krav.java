package se.fk.mimer.producermodels.v2.model.produceratresultat.krav;
...
{
    @Builder
    public Krav( UUID id, UUID faststallsForKundbehov, int revision, String variant, Person avserPerson, Period giltighetsperiod, String typ, String status,
