...
{
    @Builder
    public KarenstidEnskildNaringsidkare( UUID id, int revision, String variant, UUID faststallsForKundbehov, Person avserPerson, Period giltighetsperiod, String typ, String status,
