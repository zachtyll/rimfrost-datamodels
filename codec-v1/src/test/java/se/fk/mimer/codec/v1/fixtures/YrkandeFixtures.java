...
import static se.fk.mimer.codec.v1.fixtures.ErbjudandeFixtures.createErbjudande;
...
public class YrkandeFixtures
{
    ...
    public static Yrkande createYrkande()
    {
        return Yrkande.builder()
                ...
                .avserSakfragaStallningstagande( List.of( BidragssparrFixtures.createBidragssparr() ) )
